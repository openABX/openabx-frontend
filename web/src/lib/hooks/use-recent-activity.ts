...
const ABD_ID = 'c7d1dab489ee40ca4e6554efc64a64e73a9f0ddfdec9e544c82c1c6742ccc500'
const ABX_ID = '9b3070a93fd5127d8c39561870432fdbc79f598ca8dbf2a3398fc100dfd45f00'

function classify(alphDelta: bigint, abdDelta: bigint, abxDelta: bigint): ActivityKind {
  ...
  if (abxDelta === 0n && abdDelta === 0n && alphDelta < 0n) return 'addCollateral'
  if (abxDelta === 0n && abdDelta === 0n && alphDelta > 0n) return 'withdrawCollateral'
