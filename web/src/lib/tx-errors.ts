...
const RULES: MatchRule[] = [
  ...
  // Min pool deposit — error 3010
  {
    ...
    message: () =>
      'Pool deposit below minimum (50 ABD). Increase the amount.',
  },
  ...
  // Not enough approved balance
  {
    ...
    message: (e) => {
      ...
      const tokenName =
        tok === '9b3070a93fd5127d8c39561870432fdbc79f598ca8dbf2a3398fc100dfd45f00'
          ? 'ABX'
          : tok === 'c7d1dab489ee40ca4e6554efc64a64e73a9f0ddfdec9e544c82c1c6742ccc500'
          ? 'ABD'
          : 'token'
