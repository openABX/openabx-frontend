  ...
  return (
    <section className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
      {TIERS.map((tier) => {
        ...
        return (
          <div key={tier.discount} className="card flex flex-col gap-3 p-5">
            ...
            <p className="text-xs text-muted-foreground">
              Every 1 ABD deposited → {(1 + tier.discount / 100).toFixed(2)} USD
              of ALPH at liquidation time, minus the bid-success fee.
            </p>
          </div>
        );
      })}
