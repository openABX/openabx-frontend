...
const BASELINES: Baseline[] = [
  {
    ...
    role: 'ABD Token',
    codeHash: 'df072c61d3234452cdf90024a30ff6663db8f840aca64669941d30d82d9e6906',
  },
  {
    address: '258k9T6WqezTLdfGvHixXzK1yLATeSPuyhtcxzQ3V2pqV',
    role: 'ABX Token',
    codeHash: '0ac1a499bf773f8aefc895e13569fe58d7386912f182bc818bb22022a682f296',
  },
  {
    address: 'tpxjsWJSaUh5i7XzNAsTWMRtD9QvDTV9zmMNeHHS6jQB',
    role: 'LoanManager',
    codeHash: 'c7c9dcd33919f02173362b33417eed70afdc6fffb1c254bf560123ef5a99cedc',
  },
  {
    address: '29YL53teVrvK2o4P2cVej8aCGN7iQS8mE86bgxA2oFWa3',
    role: 'AuctionManager',
    codeHash: '035535107ed47e0458df6e7313d88154b17181a95eed070a398d1de0c1065a2a',
  },
  {
    address: '2AtjFo5tY8vjxtdni43wyVaq4VczV6WBwBu5Qw9Yaiec7',
    role: 'DIAAlphPriceAdapter',
    codeHash: '54ae42d3b1a7dde12ab95308845d4412c57b07048351e937b1cc18488d3788d5',
  },
  {
    address: '28Nju5bkxygKQp3SEw29jELwgTL4zpJZjwXNgaUzU3otT',
    role: 'AbdPriceOracle',
    codeHash: '8144226f143d8e1a795cbc91a3101cbb7e2524e85730f6cfaa41bdc90239dd55',
  },
  {
    address: '21WqbuxJbLBYHxAQhr99JGJH5QKqX5JqkDnDZy7kautUf',
    role: 'PlatformSettings',
    codeHash: '5392a356e4966c757cb7a1b8de71fd7640cd0149f24261863220b49c93921ba4',
  },
]
...
async function main(): Promise<void> {
  ...
  for (const base of BASELINES) {
    try {
      ...
      errors.push(`ERROR ${base.role} (${base.address}): ${(err as Error).message}`)
    }
  }
