...
const CONTRACTS: Array<{ address: string; role: string; confidence: 'high' | 'medium' }> = [
  { address: 'tpxjsWJSaUh5i7XzNAsTWMRtD9QvDTV9zmMNeHHS6jQB', role: 'loanManager', confidence: 'high' },
  { address: '29YL53teVrvK2o4P2cVej8aCGN7iQS8mE86bgxA2oFWa3', role: 'auctionManager', confidence: 'high' },
  { address: '288xqicj5pfGWuxJLKYU78Pe55LENz4ndGXRoykz7NL2K', role: 'abdToken', confidence: 'high' },
  { address: '258k9T6WqezTLdfGvHixXzK1yLATeSPuyhtcxzQ3V2pqV', role: 'abxToken', confidence: 'high' },
  { address: '21WqbuxJbLBYHxAQhr99JGJH5QKqX5JqkDnDZy7kautUf', role: 'platformSettings', confidence: 'high' },
  { address: '2AtjFo5tY8vjxtdni43wyVaq4VczV6WBwBu5Qw9Yaiec7', role: 'diaAlphPriceAdapter', confidence: 'high' },
  { address: '28Nju5bkxygKQp3SEw29jELwgTL4zpJZjwXNgaUzU3otT', role: 'abdPriceOracle', confidence: 'high' },
  { address: '22qGq3kq2QMCnX4HwXc9bt2AzRjwoGRmXS4Qoc687rLYf', role: 'unknown-1178b (likely BorrowerOperations)', confidence: 'medium' },
  { address: '24nvcVvScyWY1tJKMepAABwVnAVXP7KsjVrqmc4jAhD11', role: 'unknown-2574b', confidence: 'medium' },
  { address: 'uHKrQGuTtoRwR6ahAUhwdvrdcg4YVNq3BsVd4frLExLX', role: 'unknown-1988b', confidence: 'medium' },
  { address: 'vh9fQ2PRGBzSuckm6yE8crpSzVM1frzRhwkWwnFDitfH', role: 'unknown-450b', confidence: 'medium' },
  { address: '28QGP95rnmZYKRBEsBeGBTdLHetoSE9nxEatVrtuN2bEF', role: 'unknown-4968b', confidence: 'medium' },
  // Newly discovered from decoding scriptOpts — see
  // references/alphbanx-contract-addresses.md follow-ups.
  { address: '28Mhs2tczfKJDUq7seTzaRctZXUhqkMzikrehxAHy2kVu', role: 'seen-in-loan-txs (candidate BorrowerOperations/LoanHelper)', confidence: 'medium' },
  { address: '211mQVddZ3SEv5dZu33E9RAvDFDKPkZdZUkJp6eMEHUxo', role: 'seen-in-loan-scripts (purpose TBD)', confidence: 'medium' },
]
...
async function fetchTxsFor(address: string, page = 1, limit = 50): Promise<ExplorerTx[]> {
